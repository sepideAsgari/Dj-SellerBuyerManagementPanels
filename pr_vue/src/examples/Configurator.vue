...
<template>
  <div class="fixed-plugin d-block d-lg-none">
    ...
    <div class="shadow-lg card">
      <div class="mt-4" @click="toggleConfigurator" :class="isRTL ? 'float-start' : 'float-end'">
        <button class="p-0 btn-close btn btn-link text-dark fixed-plugin-close-button">
          <i class="fa fa-times fa-si-x"></i>
        </button>
      </div>
      <div class="pt-0 pb-0 bg-transparent this-is-rtl card-header">
        ...
        <div class="pt-0 pb-0 bg-transparent card-header">
          <form class="form-inline my-0 pb-4 my-lg-0 d-flex align-items-center">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <h6 class="nav-link" href="#">خلاصه فعالیت ها <span class="sr-only">(current)</span></h6>
            </li>
            <li class="nav-item">
              <h6 class="nav-link" href="#">حساب کاربری</h6>
            </li>
            <li class="nav-item">
              <h6 class="nav-link" href="#">کیف پول</h6>
            </li>
            <li class="nav-item">
              <h6 class="nav-link " href="#">سفارش ها</h6>
            </li>
            <li class="nav-item">
              <h6 class="nav-link disabled" href="#">دیدگاه ها</h6>
            </li>
            <li class="nav-item">
              <h6 class="nav-link disabled" href="#">اعلان ها</h6>
            </li>
